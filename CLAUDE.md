...
### 沉淀决策规则（2026-08-04 确立）

讨论中**主动监控对话内容**，识别可补充/完善处理问题框架或体系知识的内容：
- **能直接确定需要沉淀** → 直接沉淀，不征求同意
- **不确定** → 提出沉淀理由（为什么值得沉/沉到哪/改什么），让用户决定

**禁止每轮结束时机械地问「需要沉淀吗？」**——能确定的直接做。

### 冲突反馈规则（2026-08-04 确立）

用户决定**违反总体框架**时，按风险等级分级反馈：

| 档位 | 触发条件 | 做法 |
|------|---------|------|
| 🔴 **红灯** | 不可逆/高风险/触及底线 | 明确拦下、反复确认，直到用户明知风险还说「继续」 |
| 🟡 **黄灯** | 显著偏离框架/中等风险 | 指出冲突点+代价+建议，但尊重用户决定 |
| 🟢 **静默或一句带过** | 轻微偏差/低风险 | 不打断节奏，顶多一句提醒 |

**冲突来源分两类**：① 用户忘记框架 → 提醒冲突；② **框架过时、用户直觉正确 → 主动提出更新框架**，不让用户迁就旧框架。
